...
int main(int argc, char **argv) {
    ...
    for(i = 0; fgets(buf, sizeof(buf), f);) {
        ...
        if(strcmp(instr, "nop") == 0) { app[i++] = 0; app[i++] = -1; }
        else if(strcmp(instr, "add") == 0) {
            int a25 = atoi(strsep(&s, " "));
            int a6 = atoi(strsep(&s, " "));
            int b25 = atoi(strsep(&s, " "));
            ...
            app[i++] = a6;
            app[i++] = -((strlen(b25) > 3 ? 5 : 29) | (atoi(b25) << 6));
        }
            ...
            app[i++] = a6;
            app[i++] = -((strlen(b25) > 3 ? 33 : 31) | (atoi(b25) << 6));
        }
            ...
            app[i++] = a6;
            app[i++] = -((strlen(b25) > 3 ? 32 : 30) | (atoi(b25) << 6));
        }
            ...
            app[i++] = a6;
            app[i++] = -((strlen(b25) > 3 ? 7 : 28) | (atoi(b25) << 6));
        }
            ...
            switch(type) {
            case '=': app[i++] = -( 9 | (b25 << 6)); break;
            case '!': app[i++] = -(10 | (b25 << 6)); break;
            case '>': app[i++] = -(11 | (b25 << 6)); break;
            case '<': app[i++] = -(12 | (b25 << 6)); break;
            }
        }
        else if(strcmp(instr, "off") == 0)  { app[i++] = 0; app[i++] = -13; }
        else if(strcmp(instr, "trst") == 0) { app[i++] = 0; app[i++] = -27; }
        ...
        else if(strcmp(instr, "inc") == 0) { app[i++] = 0; app[i++] = -(17 | (atoi(s) << 6)); }
        else if(strcmp(instr, "dec") == 0) { app[i++] = 0; app[i++] = -(18 | (atoi(s) << 6)); }
        else if(strcmp(instr, "tnp") == 0) { app[i++] = 0; app[i++] = -(19 | (atoi(s) << 6)); }
        ...
        else if(strcmp(instr, "open") == 0) { app[i++] = 0; app[i++] = -(34 | (atoi(s) << 6)); }
